                 ...
                 BlockDirtyBitmapOrStr **obj, Error **errp)
{
    ...
    default:
        ...
        error_setg(errp, "Invalid parameter type for '%s', expected: BlockDirtyBitmapOrStr",
                         name ? name : "null");
                 ...
                 Qcow2OverlapChecks **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: Qcow2OverlapChecks",
                         name ? name : "null");
                 ...
                 BlockdevRef **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: BlockdevRef",
                         name ? name : "null");
                 ...
                 BlockdevRefOrNull **obj, Error **errp)
{
    ...
    default:
        assert(visit_is_input(v));
        error_setg(errp, "Invalid parameter type for '%s', expected: BlockdevRefOrNull",
                         name ? name : "null");
